...
namespace Q1.Models
{
    public partial class PE_PRN231_Trial_02Context : DbContext
    {
        public PE_PRN231_Trial_02Context()
        {
        }

        public PE_PRN231_Trial_02Context(DbContextOptions<PE_PRN231_Trial_02Context> options)
            : base(options)
        {
        }
